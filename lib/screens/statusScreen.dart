              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSummaryRow('Total Income', '\$${transactions.where((t) => t.isIncome).fold(0.0, (sum, t) => sum + t.amount).toStringAsFixed(2)}'),
                    _buildSummaryRow('Total Expenses', '\$${totalExpenses.toStringAsFixed(2)}'),
                    _buildSummaryRow('Average Transaction', '\$${(transactions.isNotEmpty ? transactions.fold(0.0, (sum, t) => sum + t.amount) / transactions.length : 0).toStringAsFixed(2)}'),
                  ],
                ),
              ),
            ),
